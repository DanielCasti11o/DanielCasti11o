...
[![Tech & Tools](https://skillicons.dev/icons?i=c,cpp,git,vscode,vim,bash,docker,linux,github,ubuntu,python,javascript,html,jquery,aws,mysql,notion#gh-dark-mode-only)](https://skillicons.dev)
